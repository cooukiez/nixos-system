...
pkgs.stdenv.mkDerivation rec {
  ...
  # documentation
  postInstall = ''
    install -vDm644 ../${pname}-${version}/NEWS    $out/share/doc/${pname}/NEWS
    install -vDm644 ../${pname}-${version}/README  $out/share/doc/${pname}/README
    install -vDm644 ../${pname}-${version}/COPYING $out/share/licenses/${pname}/COPYING
  '';
